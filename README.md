...
| `DATABASE_URL` | URL подключения к базе данных | `sqlite:///./data/tf_idf.db` |
...
│   │   └── middleware.py # Middleware для валидации файлов и подсчета запросов
│   ├── metrics/      # Модуль для работы с метриками
